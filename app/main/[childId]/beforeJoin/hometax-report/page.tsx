  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="mx-3 mt-5">
        <h1 className="font-hana-cm text-[16px] leading-tight">
          유기정기금 신고를 진행해주세요.
        </h1>
      </section>
      ...
      <section className="mx-4 mt-5 space-y-1">
        <p className="font-hana-regular text-[9px] text-hana-red">
          ※ 다음 안내사항을 반드시 숙지해주세요.
        </p>
        <p className="font-hana-medium text-[10px] text-hana-gray-600 leading-relaxed">
