  ...
  return (
    <div className="w-full rounded-3xl border border-hana-gray-150 bg-white p-6 font-hana-cm shadow-sm">
      ...
      <div className="mt-2 flex flex-col items-center gap-1 text-center text-[10px] text-gray-400 leading-relaxed">
        ...
        <p>
          *증여세 신고서를 증여일이 속하는 달의 말일부터 3월 이내에 관할세무서에
          제출해야 합니다.
        </p>
      </div>
      {/* 버튼 영역: 크기 축소 및 중앙 정렬 */}
      <div className="flex flex-col items-center gap-3">
        <CustomButton
          className="h-auto w-fit min-w-40 bg-hana-carousel-bg-green px-6 py-2.5 text-hana-dark-navy transition-all active:scale-95"
